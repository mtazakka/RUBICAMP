...
import { MatakuliahView } from '../view/MatakuliahView.js'
...
export class MatakuliahController {
                        ...
                        rl.question('ID Jurusan     : ', (jurusan) => {
                            Matakuliah.tambah(id_matakuliah, nama, sks, jurusan, (err) => {
                                if (err) {
                                    ...
                                    console.log(`Matakuliah dengan ID ${id_matakuliah} telah didaftarkan.`)
                                    MatakuliahController.menu()
                                }
                            })
                        })
    ...
    static hapus() {
        rl.question(`${garis}\nmasukkan ID matakuliah yang akan dihapus:`, (id_matakuliah) => {
